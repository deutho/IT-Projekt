...
loginform: FormGroup;
  ...
  constructor(private fb: FormBuilder, private router: Router, private auth: AuthService, private app: AppService) { }
  ...
  public async onSubmit() {
    ...
    this.auth.signIn(username, password).then(() => this.router.navigate(['app'])).then(() => this.app.myHeader("Startseite")).catch((error) => {
      this.error = true;
